import pfrl
from .tool import CategoricalDQN
from .tool import _apply_categorical_projection
from .recurrent import pack_and_forward

__all__ = ['CategoricalDoubleDQN']

class CategoricalDoubleDQN(CategoricalDQN):
